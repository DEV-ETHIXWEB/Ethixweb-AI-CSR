...
| **Input**         | `{ phone: string (E.164), business_id: uuid }`                                                                                                                    |
...
| **Input**         | `{ business_id, name: {first, last}, phone: E.164, email?: string, address: {street, city, state, zip}, source: "ai_csr" }`                                                                                                                                                                                     |
...
| **Input**         | `{ customer_id, business_id, call_id, problem_summary: string, priority: "emergency"                                                                                                                                                                                                                                                                             | "urgent" | "routine" | "estimate", lead_type: "residential" | "commercial", preferred_contact_method?, transcript_ref }` |
...
| **Input**           | `{ business_id, at?: timestamp (defaults to now) }`                                                                                                                             |
...
| **Input**           | `{ business_id, call_id, description: string, detectedKeywords?: string[] }`                                                                                                                                                                                                                                                                      |
...
| **Input**           | `{ customer_id, business_id, limit?: number (default 5) }`                                                                       |
