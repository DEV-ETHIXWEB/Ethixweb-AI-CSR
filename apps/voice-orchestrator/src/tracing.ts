/**
 * OpenTelemetry bootstrap — identical rationale to apps/core-api/src/tracing.ts:
 * must be the first thing main.ts imports, and an unreachable OTel Collector
 * must never crash this service (a dropped span is acceptable; a dropped
 * call is not).
 */
