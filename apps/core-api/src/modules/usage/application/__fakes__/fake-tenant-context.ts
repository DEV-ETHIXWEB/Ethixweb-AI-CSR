 ...
 * RecordUsageUseCase — see its own comment on why a real Postgres
 * SAVEPOINT is required there) don't crash here; a fake has no real
 * transaction to poison in the first place, so a no-op is the correct
